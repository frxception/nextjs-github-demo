...
var MyDocument = /** @class */ (function (_super) {
    ...
    MyDocument.prototype.render = function () {
        return (
        // add i18n feature
        react_1["default"].createElement(document_1.Html, { lang: "en" },
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, __assign(__assign({}, initialProps), { styles: __spreadArrays(react_1["default"].Children.toArray(initialProps.styles)) })];
        }
    });
}); };
